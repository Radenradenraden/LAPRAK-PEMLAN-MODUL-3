...
public class Politik {
    ...
    public Politik(String Judul, int TahunTerbit, String Sinopsis){
        this.Judul = Judul;
    ...
    public int CekKesamaan(Politik bukuLain){
    ...
    Politik salinan = new Politik (this.Judul, this.TahunTerbit, this.Sinopsis);
