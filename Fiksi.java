...
public class Fiksi {
    ...
    public Fiksi(String Judul, int TahunTerbit, String Sinopsis){
        this.Judul = Judul;
    ...
    public int CekKesamaan(Fiksi bukuLain){
    ...
    Fiksi salinan = new Fiksi(this.Judul, this.TahunTerbit, this.Sinopsis);
