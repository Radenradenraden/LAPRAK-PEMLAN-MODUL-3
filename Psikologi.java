...
public class Psikologi {
    ...
    public Psikologi(String Judul, int TahunTerbit, String Sinopsis){
        this.Judul = Judul;
    ...
    public int CekKesamaan(Psikologi bukuLain){
    ...
    public Psikologi Copy(){

    Psikologi salinan = new Psikologi(this.Judul, this.TahunTerbit, this.Sinopsis);
