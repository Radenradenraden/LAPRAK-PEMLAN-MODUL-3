...
public class Sejarah {
    ...
    public Sejarah(String Judul, int TahunTerbit, String Sinopsis){
        this.Judul = Judul;
    ...
    public int CekKesamaan(Sejarah bukuLain){
    ...
    Sejarah salinan = new Sejarah (this.Judul, this.TahunTerbit, this.Sinopsis);
