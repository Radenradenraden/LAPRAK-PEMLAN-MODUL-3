...
public class Teknologi {
    ...
    public Teknologi(String Judul, int TahunTerbit, String Sinopsis){
        this.Judul = Judul;
    ...
    public int CekKesamaan(Teknologi bukuLain){
    ...
    Teknologi salinan = new Teknologi(this.Judul, this.TahunTerbit, this.Sinopsis);
